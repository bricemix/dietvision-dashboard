    ...
    def description_for(key)
      {
        ...
        "free_plan_daily_limit"    => "Nb de scans IA/jour — Starter (gratuit)",
        "pro_plan_daily_limit"     => "Nb de scans IA/jour — Pro",
        "premium_plan_daily_limit" => "Nb de scans IA/jour — Premium",
        "vip_plan_daily_limit"     => "Nb de scans IA/jour — VIP",
        "trial_plan_daily_limit"   => "Nb de scans IA/jour — période d'essai",
        "pro_dishes_daily_limit"     => "Plats recommandés IA / jour — Pro (rafraîchissements)",
        "premium_dishes_daily_limit" => "Plats recommandés IA / jour — Premium (rafraîchissements)",
        "vip_dishes_daily_limit"     => "Plats recommandés IA / jour — VIP (rafraîchissements)",
